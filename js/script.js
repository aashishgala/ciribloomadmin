...
quit_quiz.onclick = ()=>{
    ...
    // setTimeout(function(){window.location.href = './completed.html';}, 200);
    setTimeout(function(){window.location.href = './show_certificate.php';}, 200);
...
function optionSelected(answer){
    ...
    // setTimeout(function(){ $('.next_btn').click(); }, 30000);
    // clearTimeout();
}
...
function endAndStartTimer() {
  ...
  interval_timer = setTimeout(function(){ $('.next_btn').click(); }, 30000); 
}